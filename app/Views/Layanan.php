<section class="py-5" style="background-color: #F6F6F6;" id="layanan-desa">
    <div class="container px-5 my-5">
        <div class="text-center mb-5">
            <h2 class="fw-bolder">Layanan Desa</h2>
            <p class="lead fw-normal text-muted">Kami menyediakan berbagai layanan untuk memenuhi kebutuhan masyarakat desa.</p>
        </div>
        <div class="row gx-5">
